...
$colors = ['зеленый', 'голубой', 'желтый', 'лаванда', 'черный', 'серый', 'оранжевый', 'белый', 'терракотовый'];
...
foreach ($cars as $key => $value) {
    foreach ($value['colors'] as $color) {
        var_dump("Купите автомобиль " . $value['name'] . " цвета " . $color['name'] . " всего за: " . ($value['price'] + $color['extra']) . " руб");
    }
}
